...
public class GITDocCurrHelper(HelperFunctions helper)
{
    ...
    public static List<DataTable> GroupFAGLL03DocCurrDataWithoutProfitCenter(DataTable data)
    {
        ...
        foreach (var g in groups)
        {
            ...
            agg.Rows.Add(
                ...
                g.First().Field<string>("Payment_Terms"),
    ...
    public DataTable PivotLiabilityGLDocCurrDataWithoutProfitCenter(DataTable data)
    {
        ...
        {
            PO = r.Field<string>("Purchasing_Document"), Vendor = r.Field<string>("Vendor"),
            CC = r.Field<string>("Company_Code"),         Date   = r.Field<DateTime>("Report_Date"),
            Rev = r.Field<string>("RevisionNumber"),       Curr  = r.Field<string>("Document_Currency"),
        });
    ...
    public DataTable PivotLiabilityGLDocCurrDataWithProfitCenter(DataTable data)
    {
        ...
        {
            PO = r.Field<string>("Purchasing_Document"), Vendor = r.Field<string>("Vendor"),
            CC = r.Field<string>("Company_Code"),         PC    = r.Field<string>("Profit_Center"),
            Date = r.Field<DateTime>("Report_Date"),      Rev   = r.Field<string>("RevisionNumber"),
    ...
    public DataTable PivotFAGLL03DocCurrSNAData(DataTable data)
    {
        ...
        var groups = data.AsEnumerable().GroupBy(r => new
        {
            Vendor   = r.Field<string>("Vendor"),   Vertical = r.Field<string>("Vertical"),
            Rev      = r.Field<string>("RevisionNumber"), Date = r.Field<DateTime>("Report_Date"),
            CC       = r.Field<string>("Company_Code"),   Curr = r.Field<string>("Document_Currency"),
        });
    ...
    public static DataTable UnpivotProcessedGIT2(DataTable processedGIT)
    {
        ...
        foreach (var (src, glCode, amt, key) in results)
        {
            ...
            r["Profit_Center"]           = src["Profit_Center"];
    ...
    public DataTable DocCurrLineItemWiseAdvanceAdjustment(DataTable populatedData, DataTable liabilityData)
    {
        ...
        foreach (DataRow p in popList)
        {
            ...
            row["Amount_Doc"] = p.Field<decimal?>("Amount_Doc") ?? 0m;
            ...
            if (pivoted != null)
            {
                foreach (DataColumn col in pivoted.Table.Columns)
                {
                    ...
                    row["Advance_" + col.ColumnName] = pivoted.Field<decimal?>(col.ColumnName) ?? 0m;
                }
            }
            else
            {
